...
|---|---|---|---|
| `clinical-reference/phase-a/OPEN-SCHEMA-QUESTIONS.md` | decision register | Open-schema triage source for PHA-TB-1 | Classify touched questions as accepted/proposed/deferred/HITL-needed before implementation. |
