...
|---|---|---|---|---|---|---|
| A9B-001 A9b product implementation | _pending PRD authorship_ | _pending test-spec authorship_ | `clinical-reference/phase-a/a9b-orderset-invocation-synthesis.md`; `clinical-reference/phase-a/OPEN-SCHEMA-QUESTIONS.md` | A9b deferred from PHA-001; placeholder for HITL-gated PRD lane. | PHA-001 | Awaiting PRD/test-spec; HITL gate per PHA-TB-1 ledger. |
