...
| 3    | Accepted ADRs in `docs/adr/`                                               | Binding policy unless superseded by a later accepted ADR.       |
...
| `docs/adr/015-adr-009-011-implementation.md`                              | 3              | accepted                         | Evidence/contradiction/transform implementation contract.                                  |
| `docs/adr/016-broad-ehr-skeleton-clinical-memory.md`                      | 3              | accepted                         | Broad EHR skeleton as clinical-memory proof surface.                                       |
| `docs/adr/017-actor-attestation-review-taxonomy.md`                       | 3              | accepted if current              | Check before treating actor-attestation memos as unresolved.                               |
...
| ----- | -------- | ------------ | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | ------------------------ | -------------------------------------------------------------------------------------- |
| C-001 | P1       | triaged      | Ignored memos contain current decisions, but ignored paths are not tracked authority.                | `.gitignore`, `memos/*`                                                               | Promote durable decisions into tracked `plans/` or `docs/adr/`; keep memos as evidence.                  | Human planning gate      | Use this file and sibling PRD/test spec as tracked staging artifacts.                  |
...
| C-009 | P1       | needs-review | v0.3 memo contains proposals whose status may have changed after ADR 015/016/017.                    | `memos/pi-chart-v03-memo.md`, `docs/adr/015-*`, `docs/adr/016-*`, `docs/adr/017-*` | Reconcile memo rows against accepted ADRs and current code before using it as source.                     | v0.3 reconciliation gate | Produce accepted/superseded/pending/deferred table.                                    |
