...
<section class="agent-dock" aria-label="Pi-agent dock"><span class="play">▶</span><b>π-agent · co-pilot</b><span class="message">oof — SpO₂ under 90 again. 09:50 reassess is the one I would not snooze.</span><span>advisory only · Chart requires clinician action</span><button id="agent-open">Open</button></section>
