...
```bash
test -f .omx/plans/prd-architecture-rebase-clinical-truth-substrate.md
test -f .omx/plans/test-spec-architecture-rebase-clinical-truth-substrate.md
```

### Future ADR 018 check
...
### Future source-authority map check
